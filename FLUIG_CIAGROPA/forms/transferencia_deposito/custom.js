...
function inicializarModalAprobacion() {
    ...
    $('#aprobadoSupervisorDestino').on('click', function (e) {
        // Prevenir la selección inmediata
        e.preventDefault();
        radioAprobacionActual = this;
        mostrarModalAprobacion('Destino');
    });
...
function mostrarModalAprobacion(tipoSupervisor) {
    var cantidadTotal = '';

    // Obtener la cantidad total solo para supervisor destino
    cantidadTotal = $('#cantidadTotalDestino').val() || $('#cantidadTotal').val() || '0';

    // Actualizar el contenido del modal
    $('#modalCantidadTotal').text(cantidadTotal);
